...
array_qx = np.round(np.arange(62.305, 62.330, 0.00025), decimals=5)
array_qy = np.round(np.arange(60.305, 60.330, 0.00025), decimals=5)
...
# of the script
keep = "lower_triangle"  # 'lower_triangle', 'all'
# ==================================================================================================
