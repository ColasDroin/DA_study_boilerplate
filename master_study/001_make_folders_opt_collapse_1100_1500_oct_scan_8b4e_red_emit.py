...
d_config_beambeam["nemitt_x"] = 2.0e-6
d_config_beambeam["nemitt_y"] = 2.0e-6
...
array_qx = np.round(np.arange(62.310, 62.325, 0.001), decimals=4)
...
# ==================================================================================================
# Define study name
study_name = "opt_collapse_1100_1500_oct_scan_8b4e_red_emit"
