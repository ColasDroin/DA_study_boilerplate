...
for beam in ["lhcb1", "lhcb2"]:
    ...
    d_config_tune_and_chroma["dqx"][beam] = 0
    d_config_tune_and_chroma["dqy"][beam] = 0
...
# Beam settings
d_config_beambeam["num_particles_per_bunch"] = 1.8e11  # We start with max bunch intensity
