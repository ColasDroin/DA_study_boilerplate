...
for beam in ["lhcb1", "lhcb2"]:
    d_config_tune_and_chroma["qx"][beam] = np.nan  # ! scanned # 62.313
    d_config_tune_and_chroma["qy"][beam] = np.nan  # ! scanned # 60.318
...
array_tunes = [(62.310, 60.315), (62.311, 60.316), (62.312, 60.317)]
...
for idx_optics, (optics, current) in enumerate(zip(array_optics, array_current)):
    ...
    for idx_job, (track, angle, nb, (qx, qy)) in enumerate(
        itertools.product(track_array, array_angle, array_nb, array_tunes)
    ):
