...
# LR
d_config_beambeam["num_long_range_encounters_per_side"]["ip1"] = 16
d_config_beambeam["num_long_range_encounters_per_side"]["ip2"] = 0
d_config_beambeam["num_long_range_encounters_per_side"]["ip5"] = 16
d_config_beambeam["num_long_range_encounters_per_side"]["ip8"] = 0
...
# ==================================================================================================
array_crossing_angle = [160, 180, 200]
# ==================================================================================================
...
for idx_job, (track, crossing_angle) in enumerate(
    itertools.product(track_array, array_crossing_angle)
):
    ...
    d_config_collider["config_knobs_and_tuning"]["knob_settings"]["on_x1"] = crossing_angle
    d_config_collider["config_knobs_and_tuning"]["knob_settings"]["on_x5"] = crossing_angle
...
# ==================================================================================================
# Define study name
study_name = "new_RT_optics_simplified"
