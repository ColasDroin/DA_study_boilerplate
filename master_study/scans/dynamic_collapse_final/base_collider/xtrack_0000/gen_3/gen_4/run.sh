...
cd /afs/cern.ch/work/c/cdroin/private/example_DA_study/master_study/scans/dynamic_collapse_final/base_collider/xtrack_0000/gen_3/gen_4
python 4_create_dynamic_knob.py > output_python.txt 2> error_python.txt
