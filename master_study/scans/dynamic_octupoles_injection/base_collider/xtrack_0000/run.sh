...
cd /storage-hpc/gpfs_data/HPC/home_recovery/cdroin/dynamic_collapse/master_study/scans/dynamic_octupoles_injection/base_collider/xtrack_0000
python 2_static_configure.py > output_python.txt 2> error_python.txt
