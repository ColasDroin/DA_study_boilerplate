...
d_config_wire = {"skip_wire": False}
for ip in ["ip1", "ip5"]:
    d_config_wire[ip] = {}
    for beam_wire in ["b1", "b2"]:
        d_config_wire[ip][beam_wire] = {}
        d_config_wire[ip][beam_wire]["i"] = 350.0
        d_config_wire[ip][beam_wire]["path_knob"] = (
            f"/afs/cern.ch/work/c/cdroin/private/example_DA_study_runIII_wire/master_study/master_jobs/knobs_wire/knob_dict_350A_8sigma@30cm_{ip}_beta30_{beam_wire}.json"
        )
...
# Add wore configuration
d_config_collider["config_wire"] = d_config_wire
# ==================================================================================================
...
# ==================================================================================================
# Define study name
study_name = "collider_30cm_with_wire"
