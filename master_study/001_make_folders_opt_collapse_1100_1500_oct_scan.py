...
d_config_mad["optics_file"] = "acc-models-lhc/strengths/flat/opt_collapse_1100_1500_thin.madx"
...
array_I = np.linspace(-600, 600, 100, endpoint=True)[:5]
...
# ==================================================================================================
# Define study name
study_name = "opt_collapse_1100_1500_oct_scan"
