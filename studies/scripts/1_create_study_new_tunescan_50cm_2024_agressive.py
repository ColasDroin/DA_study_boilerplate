...
# Beam settings
d_config_beambeam["num_particles_per_bunch"] = 2.4e8  # type: ignore
d_config_beambeam["nemitt_x"] = 2.8e-6  # type: ignore
d_config_beambeam["nemitt_y"] = 2.8e-6  # type: ignore
...
# ==================================================================================================
# Define study name
study_name = "new_tunescan_50cm_2024_agressive"
