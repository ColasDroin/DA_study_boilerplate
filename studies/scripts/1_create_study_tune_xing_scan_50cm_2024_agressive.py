...
reduction_xing = np.round(np.linspace(0, 70, 8, endpoint=True), decimals=4)
# ==================================================================================================
...
for idx_job, (track, qx, red_xing) in enumerate(
    itertools.product(track_array, array_qx, reduction_xing)
):
