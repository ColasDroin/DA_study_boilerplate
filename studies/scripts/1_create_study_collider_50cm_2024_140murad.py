...
d_config_knobs["on_sep2h"] = 1e-3  # ! Need to update this value
d_config_knobs["on_sep2v"] = 0
d_config_knobs["on_x5"] = 0
d_config_knobs["on_sep5"] = 1e-3
d_config_knobs["on_x8h"] = -235
d_config_knobs["on_sep8v"] = 0
...
d_config_beambeam = {"mask_with_filling_pattern": {}, "skip_beambeam": True}

# Beam settings
d_config_beambeam["num_particles_per_bunch"] = 1.8e8  # ! Need to find the correct value here
...
# ==================================================================================================
# Define study name
study_name = "collider_50cm_2024_140murad"
